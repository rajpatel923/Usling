import { z } from 'zod';
import { BaseEnvelopeSchema } from './envelope.js';
// ── Payload schemas ───────────────────────────────────────────────────────────
...
export const APPROVED_EVENT_TYPES = Object.keys(payloads);
// ── Parser ────────────────────────────────────────────────────────────────────
export function parseEvent(raw) {
    ...
    const payloadSchema = payloads[type];
    ...
    return { ok: true, data: { ...base.data, type, payload: payloadResult.data } };
}
